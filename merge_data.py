...
for i in range(8014):
    all_info = [info[0], info[1], info[2], info[3], info[4], info[5], info[6], info[7], info[8], info[9], info[10], info[11], info[12], info[13], info[14], info[15], info[16], info[17], info[18], info[19], info[20], info[21], info[22], info[23], info[24], info[25], info[26], info[27], info[28], info[29], bios[7], bios[8], bios[9], bios[10], bios[11], bios[12], bios[13], bios[14], bios[15], bios[16], bios[17], bios[18], bios[19], bios[20], bios[21], bios[22], bios[23]]
